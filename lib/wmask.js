...
(function (w, d) {
    ...
    WMask.prototype.applyMask = function (maskName) {
        ...
        this.history.add({
            ...
            forward: function (context, callback) {
                ...
                mask = new Mask.Mask(func, selection, context);
     ...
     * @param {String} historyFunc 'forward' or 'backward'
     */
    WMask.prototype.processFrames = function (historyEntry, historyFunc) {
        ...
        this.processID = setTimeout(function renderFrame(frameIndex) {
            ...
            historyEntry[historyFunc](drawContext(completeFrame), function (imageData, w, h) {
     ...
     */
    WMask.prototype.stopDrawing = function () {
