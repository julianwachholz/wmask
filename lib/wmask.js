...
(function (w, d) {
    ...
    WMask.prototype.initMenu = function () {
        ...
        for (action in actions) {
            if (actions.hasOwnProperty(action)) {
                id('action-' + action).addEventListener('click', this[actions[action].call].bind(this, actions[action].arg));
            }
        }
     ...
     */
    WMask.prototype.history = function (direction) {
        console.warn('history not implemented yet.', direction);
    };
     ...
     */
    WMask.prototype.zoom = function (zoom) {
