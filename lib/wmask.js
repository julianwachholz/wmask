...
/*global Point: true, Rectangle: true, Filter: true, Filters: true,
...
(function (w, d) {
    ...
    WMask.prototype.initMenu = function () {
        var filters = {}, filterButtons = [];
        id('menu').style.display = 'block';

        filters.noop = id('filter-noop');
        filters.noop.addEventListener('click', this.applyFilter.bind(this, Filters.Noop));
        filterButtons.push(filters.noop);

        filters.negate = id('filter-negate');
        filters.negate.addEventListener('click', this.applyFilter.bind(this, Filters.Negate));
        filterButtons.push(filters.negate);
     ...
     */
    WMask.prototype.applyFilter = function (filterFunc) {
        var canvas = document.createElement('canvas'), context, f;
        ...
        f = new Filter(filterFunc, this.gridSize, this.selection, context);
        f.applyFilter(function (imageData) {
