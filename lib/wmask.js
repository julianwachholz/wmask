...
(function (w, d) {
    ...
    WMask.prototype.acceptMedia = function () {
        var showError, setFilename, loadImage, loadVideo, readFile, drop, click, loadFunction;
        ...
        loadImage = function (src) {
            ...
            img.addEventListener('load', function () {
                ...
                _paq.push(['trackEvent', 'image', 'load', loadFunction]);
            });
            ...
            img.addEventListener('error', function () {
                ...
                _paq.push(['trackEvent', 'image', 'load-error', loadFunction]);
            }.bind(this));
        ...
        loadVideo = function (src) {
            ...
            canplaythrough = function() {
                ...
                _paq.push(['trackEvent', 'video', 'load', loadFunction]);
            }.bind(this);
    ...
    WMask.prototype.applyMask = function (maskName) {
        ...
        _paq.push(['trackEvent', this.isVideo ? 'video' : 'image', 'action', maskName]);
    };
