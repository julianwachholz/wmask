...
(function (w, d) {
    ...
    WMask.prototype.initMenu = function () {
        ...
        for (mask in Mask.Buttons) {
            if (Mask.Buttons.hasOwnProperty(mask)) {
                id('mask-' + mask).addEventListener('click', this.applyMask.bind(this, Mask.Buttons[mask]));
    ...
    WMask.prototype.applyMask = function (maskFunc) {
        ...
        mask = new Mask.Mask(maskFunc, this.gridSize, this.selection, context);
